...
;_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(){var pkgPath,data,resolvePath,jsonStr,jsonObj,newData;return _regeneratorRuntime().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.prev=0;pkgPath=(0,core.getInput)('path');data=(0,core.getInput)('data');resolvePath=external_path_default().resolve(process.cwd(),pkgPath);if(external_fs_default().existsSync(resolvePath)){_context.next=6;break;}throw new Error("File \x1B[31;1m".concat(resolvePath,"\x1B[0m does not exist!"));case 6:_context.next=8;return external_fs_default().promises.readFile(resolvePath);case 8:_context.next=10;return _context.sent.toString();case 10:jsonStr=_context.sent;jsonObj=JSON.parse(jsonStr);if(!data){_context.next=17;break;}newData=JSON.parse(data);jsonObj=Object.assign(jsonObj,newData);_context.next=17;return external_fs_default().promises.writeFile(resolvePath,JSON.stringify(jsonObj,null,2));case 17:(0,core.startGroup)("\x1B[32;1m package.json\x1B[0m content: ");(0,core.info)("".concat(JSON.stringify(jsonObj,null,2)));(0,core.endGroup)();(0,core.setOutput)('name',jsonObj.name);(0,core.setOutput)('version',jsonObj.version);(0,core.setOutput)('description',jsonObj.description);(0,core.setOutput)('author',(jsonObj.author||{}).name||jsonObj.author);(0,core.setOutput)('keywords',(jsonObj.keywords||[]).join(','));(0,core.setOutput)('license',jsonObj.license);(0,core.setOutput)('homepage',jsonObj.homepage);(0,core.setOutput)('repository',(jsonObj.repository||{}).url||jsonObj.repository);(0,core.setOutput)('os',(jsonObj.os||[]).join(','));_context.next=34;break;case 31:_context.prev=31;_context.t0=_context["catch"](0);(0,core.setFailed)(_context.t0.message);case 34:case"end":return _context.stop();}}},_callee,null,[[0,31]]);}))();
})();
